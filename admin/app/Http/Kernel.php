...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Admin\Http\Middleware\PreventRequestsDuringMaintenance::class,
     ...
     *
     * @var array<non-empty-string, class-string|non-empty-string>
     */
    protected $middlewareAliases = [
        ...
        'signed' => \Admin\Http\Middleware\ValidateSignature::class,
