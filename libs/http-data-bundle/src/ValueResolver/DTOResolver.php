...
use Local\HttpData\Attribute\MapRequestPayloadAttribute;
...
abstract class DTOResolver implements ValueResolverInterface
{
     ...
     */
    protected function hydrate(array $data, ArgumentMetadata $argument, MapRequestPayloadAttribute $attribute): object
    {
